if (window && window.innerWidth >= 1024) {
    ...
    $(".main").onepage_scroll({
        ...
        beforeMove: function(index) {
            ...
            var spiningStar = $('.content__item')
            if (bodyClass === 'viewing-page-1') {
...
$(function() {
    ...
    var dd = new DropDown($('#dd'), 'absolute', '220px', '#fff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', 'ffffff');
